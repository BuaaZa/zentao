...
$lang->testtask->testParent = "父测试单";
$lang->testtask->handleCase = "父测试单用例";
$lang->testtask->handle0 = "转移到当前测试单下";
$lang->testtask->handle1 = "直接删除";
$lang->testtask->handle2 = "创建默认子测试单，并转移到该测试单下";
$lang->testtask->parentNoCase = "所属测试单均未绑定用例。\n非叶子结点，无法直接绑定用例。";
$lang->testtask->allTestTask = "所有测试单";
$lang->testtask->noTestTask = "无测试单";

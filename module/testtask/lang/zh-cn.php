...
$lang->testtask->edit             = "编辑测试集";
$lang->testtask->browse           = "测试集列表";
$lang->testtask->linkCase         = "关联用例";
$lang->testtask->selectVersion    = "选择测试集";
...
$lang->testtask->wait             = "待测测试集";
$lang->testtask->waitAB           = "待测试";
$lang->testtask->block            = "阻塞";
$lang->testtask->activate         = "激活";
$lang->testtask->testing          = "测试中测试集";
$lang->testtask->testingAB        = "测试中";
$lang->testtask->blocked          = "被阻塞测试集";
$lang->testtask->done             = "已测测试集";
...
$lang->testtask->task             = '测试集';
$lang->testtask->run              = '执行编号';
$lang->testtask->job              = '构建任务';
$lang->testtask->compile          = '构建';
$lang->testtask->duration         = '持续时间';

$lang->testtask->viewAction     = "测试集概况";
$lang->testtask->casesAction    = '查看用例';
$lang->testtask->activateAction = "激活测试集";
$lang->testtask->blockAction    = "阻塞测试集";
$lang->testtask->closeAction    = "关闭测试集";
$lang->testtask->startAction    = "开始测试集";
...
$lang->testtask->pageSummary       = '本页共 <strong>%s</strong> 个测试集。';
$lang->testtask->mySummary         = '本页共 <strong>%s</strong> 个测试集，待测试测试集 <strong>%s</strong>，测试中测试集 <strong>%s</strong>，被阻塞测试集 <strong>%s</strong>。';
$lang->testtask->allSummary        = '本页共 <strong>%s</strong> 个测试集，待测试测试集 <strong>%s</strong>，测试中测试集 <strong>%s</strong>，被阻塞测试集 <strong>%s</strong>，已测测试集 <strong>%s</strong>。';
$lang->testtask->checkedAllSummary = '共选中 <strong>%total%</strong> 个测试集，待测试测试集 <strong>%wait%</strong>，测试中测试集 <strong>%testing%</strong>，被阻塞测试集 <strong>%blocked%</strong>，已测测试集 <strong>%done%</strong>。';

$lang->testtask->beginAndEnd = '起止时间';
$lang->testtask->to          = '至';

$lang->testtask->legendDesc      = '测试集描述';
...
$lang->testtask->linkByBuild   = '复制测试集';
$lang->testtask->linkByStory   = "按{$lang->SRCommon}关联";
$lang->testtask->linkByBug     = '按缺陷关联';
...
$lang->testtask->confirmDelete     = '您确认要删除该测试集吗？';
$lang->testtask->confirmUnlinkCase = '您确认要移除该用例吗？';
$lang->testtask->noticeNoOther     = '该产品还没有其他测试集';
$lang->testtask->noTesttask        = '暂时没有测试集。';
$lang->testtask->checkLinked       = "请检查测试集的产品是否与{$lang->executionCommon}相关联";
...
$lang->testtask->mail->create->title = "%s创建了测试集 #%s:%s";
$lang->testtask->mail->edit->title   = "%s编辑了测试集 #%s:%s";
$lang->testtask->mail->close->title  = "%s关闭了测试集 #%s:%s";

$lang->testtask->action = new stdclass();
$lang->testtask->action->testtaskopened  = '$date, 由 <strong>$actor</strong> 创建测试集 <strong>$extra</strong>。' . "\n";
$lang->testtask->action->testtaskstarted = '$date, 由 <strong>$actor</strong> 启动测试集 <strong>$extra</strong>。' . "\n";
$lang->testtask->action->testtaskclosed  = '$date, 由 <strong>$actor</strong> 完成测试集 <strong>$extra</strong>。' . "\n";

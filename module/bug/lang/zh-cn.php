...
$lang->bug->steps            = '重现步骤';
$lang->bug->status           = '缺陷状态';
$lang->bug->statusAB         = '状态';
$lang->bug->subStatus        = '子状态';
$lang->bug->activatedCount   = '重新打开次数';
$lang->bug->activatedCountAB = '重新打开次数';
$lang->bug->activatedDate    = '重新打开日期';
...
$lang->bug->duplicateBug     = '重复缺陷';
$lang->bug->lastEditedBy     = '最后修改者';
$lang->bug->linkBug          = '相关缺陷';
$lang->bug->linkBugs         = '关联相关缺陷';
$lang->bug->unlinkBug        = '移除相关缺陷';
$lang->bug->case             = '相关用例';
$lang->bug->caseVersion      = '用例版本';
$lang->bug->testtask         = '测试集';
$lang->bug->files            = '附件';
...
$lang->bug->index              = '首页';
$lang->bug->create             = '提缺陷';
$lang->bug->batchCreate        = '批量提缺陷';
$lang->bug->confirmBug         = '确认';
$lang->bug->confirmAction      = '确认缺陷';
...
$lang->bug->assignAction       = '指派缺陷';
$lang->bug->batchAssignTo      = '批量指派';
$lang->bug->browse             = '缺陷列表';
$lang->bug->view               = '缺陷详情';
$lang->bug->resolve            = '解决';
$lang->bug->resolveAction      = '解决缺陷';
$lang->bug->batchResolve       = '批量解决';
$lang->bug->close              = '关闭';
$lang->bug->closeAction        = '关闭缺陷';
$lang->bug->activate           = '重新打开';
$lang->bug->activateAction     = '重新打开缺陷';
$lang->bug->batchActivate      = '批量重新打开';
$lang->bug->reportChart        = '报表统计';
$lang->bug->reportAction       = '缺陷报表统计';
$lang->bug->export             = '导出数据';
$lang->bug->exportAction       = '导出缺陷';
$lang->bug->delete             = '删除';
$lang->bug->deleteAction       = '删除缺陷';
...
$lang->bug->my                 = '我的';
$lang->bug->yesterdayResolved  = '昨天解决缺陷数';
...
$lang->bug->ditto          = '同上';
$lang->bug->dittoNotice    = '该缺陷与上一缺陷不属于同一产品！';
$lang->bug->noAssigned     = '未指派';
$lang->bug->noBug          = '暂时没有缺陷。';
...
/* 交互提示。*/
$lang->bug->summary               = "本页共 <strong>%s</strong> 个缺陷，未解决 <strong>%s</strong>。";
$lang->bug->confirmChangeProduct  = "修改{$lang->productCommon}会导致相应的{$lang->executionCommon}、{$lang->SRCommon}和任务发生变化，确定吗？";
$lang->bug->confirmDelete         = '您确认要删除该缺陷吗？';
$lang->bug->remindTask            = '该缺陷已经转化为任务，是否更新任务(编号:%s)状态 ?';
$lang->bug->skipClose             = '缺陷 %s 不是已解决状态，不能关闭，将自动忽略。';
$lang->bug->executionAccessDenied = "您无权访问该缺陷所属的{$lang->executionCommon}！";
$lang->bug->stepsNotEmpty         = "重现步骤不能为空。";
$lang->bug->confirmUnlinkBuild    = "更换解决版本将取消与旧版本的关联，您确定取消该缺陷与%s的关联吗？";
$lang->bug->noSwitchBranch        = '缺陷%s所属模块不在当前分支下，将自动忽略。';
$lang->bug->confirmToStory        = '转需求后缺陷将自动关闭，关闭原因为转为需求。';
...
$lang->bug->resolutionList['duplicate']  = '重复缺陷';
...
$lang->bug->report->charts['bugsPerExecution']      = $lang->executionCommon . '缺陷数量';
$lang->bug->report->charts['bugsPerBuild']          = '版本缺陷数量';
$lang->bug->report->charts['bugsPerModule']         = '模块缺陷数量';
$lang->bug->report->charts['bugsPerStory']         = '需求缺陷数量';
$lang->bug->report->charts['bugsPerProject']         = '项目缺陷数量';
$lang->bug->report->charts['openedBugsPerDay']      = '每天新增缺陷数';
$lang->bug->report->charts['resolvedBugsPerDay']    = '每天解决缺陷数';
$lang->bug->report->charts['closedBugsPerDay']      = '每天关闭的缺陷数';
$lang->bug->report->charts['openedBugsPerUser']     = '每人提交的缺陷数';
$lang->bug->report->charts['resolvedBugsPerUser']   = '每人解决的缺陷数';
$lang->bug->report->charts['closedBugsPerUser']     = '每人关闭的缺陷数';
$lang->bug->report->charts['bugsPerSeverity']       = '按缺陷严重程度统计';
$lang->bug->report->charts['bugsPerResolution']     = '按缺陷解决方案统计';
$lang->bug->report->charts['bugsPerStatus']         = '按缺陷状态统计';
$lang->bug->report->charts['bugsPerActivatedCount'] = '按缺陷重新打开次数统计';
$lang->bug->report->charts['bugsPerPri']            = '按缺陷优先级统计';
$lang->bug->report->charts['bugsPerType']           = '按缺陷类型统计';
...
$lang->bug->report->bugsPerStory         = new stdclass();
...
$lang->bug->report->bugsPerStory->graph         = new stdclass();
...
$lang->bug->report->bugsPerActivatedCount->graph->xAxisName = '重新打开次数';
...
$lang->bug->action->linkrelatedbug      = array('main' => '$date, 由 <strong>$actor</strong> 关联相关缺陷 <strong>$extra</strong>。');
$lang->bug->action->unlinkrelatedbug    = array('main' => '$date, 由 <strong>$actor</strong> 移除相关缺陷 <strong>$extra</strong>。');

...
$lang->action->objectTypes['bug']              = '缺陷';
...
$lang->action->objectTypes['testtask']         = '测试集';
...
$lang->action->desc->bugconfirmed         = '$date, 由 <strong>$actor</strong> 确认缺陷。' . "\n";
$lang->action->desc->frombug              = '$date, 由 <strong>$actor</strong> 缺陷转化而来，缺陷编号为 <strong>$extra</strong>。';
...
$lang->action->desc->linked2testtask      = '$date 由 <strong>$actor</strong> 关联到测试集 <strong>$extra</strong>';
$lang->action->desc->unlinkedfromtesttask = '$date 由 <strong>$actor</strong> 从测试集 <strong>$extra</strong> 中移除';
...
$lang->action->desc->linkbug     = '$date, 由 <strong>$actor</strong> 关联缺陷 <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkstory = '$date, 由 <strong>$actor</strong> 从计划移除需求 <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkbug   = '$date, 由 <strong>$actor</strong> 从计划移除缺陷 <strong>$extra</strong>。' . "\n";
...
$lang->action->label->linkrelatedbug        = "关联了相关缺陷";
$lang->action->label->unlinkrelatedbug      = "移除了相关缺陷";
...
$lang->action->label->linkbug               = '关联缺陷到';
$lang->action->label->unlinkstory           = '移除需求从';
$lang->action->label->unlinkbug             = '移除缺陷从';
...
$lang->action->dynamicAction->productplan['linkbug']     = "关联缺陷";
$lang->action->dynamicAction->productplan['unlinkbug']   = "移除缺陷";
...
$lang->action->dynamicAction->bug['opened']              = '创建缺陷';
$lang->action->dynamicAction->bug['importfromgitlab']    = "从Gitlab关联创建缺陷";
$lang->action->dynamicAction->bug['edited']              = '编辑缺陷';
$lang->action->dynamicAction->bug['activated']           = '重新打开缺陷';
$lang->action->dynamicAction->bug['assigned']            = '指派缺陷';
$lang->action->dynamicAction->bug['closed']              = '关闭缺陷';
$lang->action->dynamicAction->bug['bugconfirmed']        = '确认缺陷';
$lang->action->dynamicAction->bug['resolved']            = '解决缺陷';
$lang->action->dynamicAction->bug['undeleted']           = '还原缺陷';
$lang->action->dynamicAction->bug['hidden']              = '隐藏缺陷';
$lang->action->dynamicAction->bug['deleted']             = '删除缺陷';
...
$lang->action->dynamicAction->bug['linked2plan']         = "缺陷关联计划";
$lang->action->dynamicAction->bug['unlinkedfromplan']    = "计划移除缺陷";
$lang->action->dynamicAction->bug['linked2release']      = '缺陷关联发布';
$lang->action->dynamicAction->bug['unlinkedfromrelease'] = '发布移除缺陷';
$lang->action->dynamicAction->bug['linked2bug']          = '缺陷关联版本';
$lang->action->dynamicAction->bug['unlinkedfrombuild']   = '版本移除缺陷';
$lang->action->dynamicAction->bug['fromsonarqube']       = '由SonarQube问题创建';

$lang->action->dynamicAction->testtask['opened']    = '创建测试集';
$lang->action->dynamicAction->testtask['edited']    = '编辑测试集';
$lang->action->dynamicAction->testtask['started']   = '启动测试集';
$lang->action->dynamicAction->testtask['activated'] = '激活测试集';
$lang->action->dynamicAction->testtask['closed']    = '完成测试集';
$lang->action->dynamicAction->testtask['blocked']   = '阻塞测试集';
...
$lang->action->label->bug          = '缺陷|bug|view|bugID=%s';
$lang->action->label->case         = '用例|testcase|view|caseID=%s';
$lang->action->label->testtask     = '测试集|testtask|view|caseID=%s';
...
$lang->action->search->objectTypeList['bug']         = '缺陷';
...
$lang->action->search->objectTypeList['testtask']    = '测试集';
...
$lang->action->apiTitle->bugconfirmed          = '确认了缺陷。';
$lang->action->apiTitle->frombug               = '缺陷转化而来，缺陷编号为 <strong>%s</strong>。';
...
$lang->action->apiTitle->linked2testtask       = '关联到测试集 <strong>%s</strong>';
...
$lang->action->apiTitle->linkrelatedbug        = "关联了相关缺陷";
$lang->action->apiTitle->unlinkrelatedbug      = "移除了相关缺陷";

            ...
            <?php else: ?>
                <table class='table table-bordered table-fixed table-recorded has-sort-head'>
                    ...
                    <tr class='text-center'>
                        ...
                        <th class="thWidth"><?php echo $lang->task->sync2WbsStatus; ?></th>
                    ...
                    <?php foreach ($efforts as $effort): ?>
                        <tr class="text-center">
                            ...
                            <td title="<?php echo $effort->left . ' ' . $lang->execution->workHour; ?>">
                                <?php echo $effort->left . ' ' . $lang->execution->workHourUnit; ?>
                            </td>
                            <td class="status-<?php echo ($effort->syncStatus =='0')?'fail':'success'; ?>"
                                    title="<?php echo ($effort->syncStatus =='0')?$lang->task->sync2WbsFail:$lang->task->sync2WbsSuccess; ?>">
                                <?php echo ($effort->syncStatus =='0')?$lang->task->sync2WbsFail:$lang->task->sync2WbsSuccess; ?>
                            </td>

...
js::set('confirmDelete',  $lang->ztinterface->confirmDelete);
js::set('batchDelete',    $lang->ztinterface->confirmBatchDelete);
  ...
  <div class='side-col' id='sidebar'>
    ...
    <div class='cell'>
      ...
      <div class='text-center'>
        <?php if(!empty($productID)) common::printLink('tree', 'browse', "productID=$productID&view=ztinterface&currentModuleID=0&branch=0&from={$this->app->tab}", $lang->tree->manage, '', "class='btn btn-info btn-wide' data-app='{$this->app->tab}'");?>
        <hr class="space-sm" />
      </div>
    </div>
  </div>

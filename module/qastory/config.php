...
$config->story->custom->batchCreateTaskpointFields = 'module,plan,spec,pri,estimate,review,%s';
...
$config->story->datatable->fieldList['actions']['width']    = $app->tab == 'project' ? '220' : ($app->tab == 'qa' ? '90' : '210');

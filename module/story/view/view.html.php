...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    ...
    <?php common::printLink('story', 'create', "productID={$story->product}&branch={$story->branch}&moduleID={$story->module}&$otherParam&bugID=0&planID=0&todoID=0&extra=&type=taskPoint&storyID=$story->id", "<i class='icon icon-plus'></i> " . $lang->story->createTaskPoint, '', "class='btn btn-primary' data-app='$from'"); ?>
    <?php endif;?>
  </div>
  <?php endif;?>
</div>

    ...
    <div class='modal-dialog'>
        ...
        <div class='modal-body'>
            <table class='table table-bordered' id='checker'>
                ...
                <tr>
                    <th><?php echo $lang->install->xml; ?></th>
                    <td><?php $xmlResult == 'ok' ? printf($lang->install->loaded) : printf($lang->install->unloaded); ?></td>
                    <td class='<?php echo $xmlResult; ?>'><?php echo $lang->install->$xmlResult; ?></td>
                    <td class='text-left f-12px'><?php if ($xmlResult == 'fail') echo $lang->install->xmlFail; ?></td>
                </tr>
                <tr>
                    <th><?php echo $lang->install->zip; ?></th>
                    <td><?php $zipResult == 'ok' ? printf($lang->install->loaded) : printf($lang->install->unloaded); ?></td>
                    <td class='<?php echo $zipResult; ?>'><?php echo $lang->install->$zipResult; ?></td>
                    <td class='text-left f-12px'><?php if ($zipResult == 'fail') echo $lang->install->zipFail; ?></td>
                </tr>
                <tr>

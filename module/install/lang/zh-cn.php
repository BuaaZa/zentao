...
<div>
  ...
  <p> 【协同研发平台】提供基于项目集管理模式，增加了项目集和执行的概念。下面是项目集管理模式的介绍：</p>
...
$lang->install->xml          = 'xml扩展';
$lang->install->xmlFail      = '修改PHP配置文件，加载xml和xmlWriter扩展。';
$lang->install->zip          = 'zip扩展';
$lang->install->zipFail      = '修改PHP配置文件，加载zip扩展。';
...
$lang->install->modeList['classic'] = '经典管理模式<p style="color: red">todo需要删除</p>';

...
$lang->testreport->bugTitle    = '缺陷 标题';
...
$lang->testreport->legacyBugs  = '遗留的缺陷';
...
$lang->testreport->legendLegacyBugs  = '遗留的缺陷';
$lang->testreport->legendReport      = '报表';
$lang->testreport->legendComment     = '总结';
$lang->testreport->legendMore        = '更多功能';
$lang->testreport->date              = '日期';

$lang->testreport->bugSeverityGroups   = '缺陷严重级别分布';
$lang->testreport->bugTypeGroups       = '缺陷类型分布';
$lang->testreport->bugStatusGroups     = '缺陷状态分布';
$lang->testreport->bugOpenedByGroups   = '缺陷创建者分布';
$lang->testreport->bugResolvedByGroups = '缺陷解决者分布';
$lang->testreport->bugResolutionGroups = '缺陷解决方案分布';
$lang->testreport->bugModuleGroups     = '缺陷模块分布';
$lang->testreport->bugStageGroups      = '缺陷重要程度阶段分布';
$lang->testreport->bugHandleGroups     = '缺陷每日处理情况分布';
$lang->testreport->legacyBugs          = '遗留的缺陷';
$lang->testreport->bugConfirmedRate    = '有效缺陷率 (方案为已解决或延期 / 状态为已解决或已关闭)';
$lang->testreport->bugCreateByCaseRate = '用例发现缺陷率 (用例创建的缺陷 / 时间区间中新增的缺陷)';

$lang->testreport->bugStageList = array();
$lang->testreport->bugStageList['generated'] = '产生的缺陷';
$lang->testreport->bugStageList['legacy']    = '遗留的缺陷';
$lang->testreport->bugStageList['resolved']  = '解决的缺陷';
...
$lang->testreport->foundBugTip     = "影响版本在测试轮次内，并且创建时间在测试时间范围内产生的缺陷数。";
$lang->testreport->legacyBugTip    = "缺陷状态是激活，或缺陷的解决时间在测试结束时间之后。";
$lang->testreport->activatedBugTip = "在测试集时间范围内被激活的缺陷数量。";
$lang->testreport->fromCaseBugTip  = "测试时间范围内，用例执行失败后创建的缺陷。";
...
共发现<strong>%s</strong>个缺陷 <a data-toggle='tooltip' class='text-warning' title='{$lang->testreport->foundBugTip}'><i class='icon-help'></i></a>，
遗留<strong>%s</strong>个缺陷 <a data-toggle='tooltip' class='text-warning' title='{$lang->testreport->legacyBugTip}'><i class='icon-help'></i></a>。
重新激活<strong>%s</strong>个缺陷 <a data-toggle='tooltip' class='text-warning' title='{$lang->testreport->activatedBugTip}'><i class='icon-help'></i></a>。
用例执行产生<strong>%s</strong>个缺陷 <a data-toggle='tooltip' class='text-warning' title='{$lang->testreport->fromCaseBugTip}'><i class='icon-help'></i></a>。
有效缺陷率（方案为已解决或延期 / 状态为已解决或已关闭）：<strong>%s</strong>，用例发现缺陷率（用例创建的缺陷 / 发现缺陷数）：<strong>%s</strong>
EOD;

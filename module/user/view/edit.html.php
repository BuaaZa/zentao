    ...
    <div class="center-block">
        <div class="main-header">
            <h2>
                ...
                <strong><?php if (!common::printLink('user', 'view', "userID=$user->id", $user->realname)) echo $user->realname; ?>
                    <small>(<?php echo $user->account; ?>)</small></strong>
            ...
            <table align='center' class='table table-form'>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Disable input account by browser automatically. -->
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Disable input password by browser automatically. -->

...
$lang->user->errorDeny    = "抱歉，您无权访问『<b>%s</b>』模块的『<b>%s</b>』功能。请联系管理员获取权限。请回到首页或重新登录。";
$lang->user->errorView    = "抱歉，您无权访问『<b>%s</b>』视图。请联系管理员获取权限。请回到首页或重新登录。";
...
$lang->user->error->noavatar         = "该用户没有上传头像";
$lang->user->error->avatarlost       = "用户头像找不到了";

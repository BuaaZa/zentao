...
<div id="mainContent" class="main-content">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->story->createTaskPoint;?></h2>
    ...
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
        <tbody>
          <tr>
            <th><?php echo $lang->story->parent;?></th>
              <td colspan="4">
                ...
                <?php $storyID = 1 ?>
                <?php echo tools::desabledSelect('parent', $stories, $storyID, "class='form-control chosen'");?>
                </div>
              </td>
          </tr>
          <tr>
            ...
            <td colspan="2">
              <div class='input-group'>
              <?php echo tools::desabledSelect('product', $products, $productID, "onchange='loadProduct(this.value);' class='form-control chosen control-product'");?>
            ...
            <td colspan="2">
              <div class='input-group' id='moduleIdBox'>
                ...
                <?php
                  echo tools::desabledSelect('module', $moduleOptionMenu, $moduleID, "class='form-control chosen'");
          ...
          <?php endif;?>
          <tr>
            <th><?php echo $lang->story->taskPointName;?></th>
            <td colspan="4">
              <div class='table-row'>

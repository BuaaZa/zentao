        ...
        <tbody>
          <tr>
            ...
            <td colspan="2">
              ...
              <?php
                $products[""] = "";
                echo html::select('product', $products, empty($productID)?'':$productID, "onchange=\"$('#parent_select1').load('/www/api.php/v1/getparenthtml/'+this.value+'?execution='+".$fromExecution.");$('#parent_select2').load('/www/api.php/v1/getparenthtml/'+this.value+'?execution='+".$fromExecution.");\" class='form-control chosen control-product' required");?>
          ...
          <tr class='sourceBox <?php echo $hiddenSource;?>'>
            ...
            <td colspan='<?php echo $feedback>0?1:2;?>'>
              <?php echo html::select('source', $lang->story->sourceList, $source, "class='form-control chosen'");?>
            </td>
            <td colspan="<?php echo $feedback>0?1:2;?>" class="sourceTd">
              <div class="input-group">
            ...
            <td colspan="2" id='feedbackBox' class='<?php echo $feedback>0?'':'hidden';?>'>
              <div class="input-group">
                <div class="input-group">
                  <div class="input-group-addon" style="min-width: 77px;"><?php echo $lang->story->feedbackBy;?></div>
                  <?php echo html::input('feedbackBy', $feedbackBy, "class='form-control' readonly");?>
                  <span class='input-group-addon'><?php echo $lang->story->notifyEmail;?></span>
                  <?php echo html::input('notifyEmail', $notifyEmail, "class='form-control' readonly");?>
                </div>
              </div>
            </td>
          </tr>
        ...
        <tfoot>
          <tr>
            <td colspan="5" class="text-center form-actions">
              ...
              <?php echo html::hidden('feedback', $feedback);?>

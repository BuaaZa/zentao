        ...
        <tbody>
          <tr>
            ...
            <td colspan="2">
              ...
              <?php
                $products[""] = "";
                echo html::select('product', $products, '', "onchange=\"$('#parent_select1').load('/www/api.php/v1/getparenthtml/'+this.value+'?execution='+".$fromExecution.");$('#parent_select2').load('/www/api.php/v1/getparenthtml/'+this.value+'?execution='+".$fromExecution.");\" class='form-control chosen control-product' required");?>

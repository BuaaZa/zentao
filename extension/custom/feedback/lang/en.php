...
$lang->feedback->allProduct        = 'All Product';
...
$lang->feedback->action->tostory = array('main' => '$date, converted to '.$lang->SRCommon.'by <strong>$actor</strong>. Its ID was <strong>$extra</strong>.');
$lang->feedback->action->tobug = array('main' => '$date, converted to Bug by <strong>$actor</strong>. Its ID was <strong>$extra</strong>.');
$lang->feedback->action->totask = array('main' => '$date, converted to Task by <strong>$actor</strong>. Its ID was <strong>$extra</strong>.');
...
// $lang->feedback->featureBar['admin']['closed']     = 'Closed';
...
$lang->feedback->featureBar['admin']['all']        = 'All';
$lang->feedback->featureBar['admin']['review']     = 'Review';
$lang->feedback->featureBar['admin']['clarify']    = 'To Be Clarified';
$lang->feedback->featureBar['admin']['commenting'] = 'Doing';
$lang->feedback->featureBar['admin']['closed']     = 'Closed';
...
$lang->feedback->notFound = '404 Not found';
$lang->feedback->accessDenied = 'Access denied to this feedback!';
$lang->feedback->clarifyclose = 'Unable to close feedback to be clarified';

...
$('#taskProjectButton').on('click', function()
{
    ...
    {
        location.href = createLink('task', 'createTask', 'executionID=' + executionID + '&storyID=0&moduleID=0&taskID=0&todoID=0&extra=projectID=' + projectID + ',feedbackID=' + feedbackID) + '#app=feedback';
    }
    else if(systemMode == 'classic' && executionID)
    {
        location.href = createLink('task', 'createTask', 'executionID=' + executionID + '&storyID=0&moduleID=0&taskID=0&todoID=0&extra=projectID=0,feedbackID=' + feedbackID) + '#app=feedback';
    }
    else if(!executionID)
    {

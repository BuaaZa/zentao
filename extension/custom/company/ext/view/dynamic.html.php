            ...
            <?php foreach ($dateGroups as $date => $actions): ?>
                ...
                <div class="dynamic <?php if ($isToday) echo 'active'; ?>">
                    <div class="dynamic-date <?php if ($browseType == 'all') echo 'c-date'; ?>">
                        ...
                        <button type="button" class="btn btn-info btn-icon btn-sm dynamic-btn"><i
                                        ...
                                        <?php if ($action->action != 'login' and $action->action != 'logout'): ?>
                                            ...
                                            <?php if ($action->objectID): ?>
                                                <span class="label label-id">
                                                    <?php echo ($action->objectType == 'module' and strpos(',created,edited,moved,', "$action->action") !== false) ? trim($action->extra, ',') : $action->objectID; ?>
                                                </span>
                                            <?php endif; ?>
...
<?php if (!empty($firstAction)): ?>
    ...
    <?php if ($hasPre or $hasNext): ?>
        <div id="mainActions" class='main-actions'>
            <nav class="container">
                <a id="prevPage" class="btn btn-info<?php if (!$hasNext) echo ' disabled'; ?>"
                   href="<?php echo $nextLink; ?>"><i class="icon icon-chevron-left"></i></a>
                <a id="nextPage" class="btn btn-info<?php if (!$hasPre) echo ' disabled'; ?>"
                   href="<?php echo $preLink; ?>"><i class="icon icon-chevron-right"></i></a>
            </nav>
        </div>
    <?php endif; ?>
<?php endif; ?>
